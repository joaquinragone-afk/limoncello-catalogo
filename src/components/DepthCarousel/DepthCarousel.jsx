...
const DepthCarousel = ({
  ...
  useEffect(() => {
    ...
    const onWheel = e => {
      ...
      // Solo capturamos gestos claramente horizontales (trackpad, shift+rueda).
      // Un scroll vertical normal tiene que poder seguir bajando la página
      // aunque el cursor pase por arriba del carrusel.
